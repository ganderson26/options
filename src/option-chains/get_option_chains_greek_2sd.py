# get_option_chains_greek_2sd.py
#
# Description: 
...
# Only save rows within 2 standard deviations
#
# Get Option Chain:
...
# crontab -e
# 30 14 * * 1-5 /Users/ganderson/anaconda3/bin/python ~/codebase/options-examples/options/src/option-chains/get_option_chains_greek_2sd.py >> ~/codebase/options-examples/options/src/option-chains/logfile_2sd.log 2>&1
#
# crontab for Monday to Friday at 12:00
# crontab -e
# 0 12 * * 1-5 /Users/ganderson/anaconda3/bin/python ~/codebase/options-examples/options/src/option-chains/get_option_chains_greek_2sd.py >> ~/codebase/options-examples/options/src/option-chains/logfile_2sd.log 2>&1
#
# crontab for Friday at 12:00
# crontab -e
# 0 12 * * 5 /Users/ganderson/anaconda3/bin/python ~/codebase/options-examples/options/src/option-chains/get_option_chains_greek_2sd.py >> ~/codebase/options-examples/options/src/option-chains/logfile_2sd.log 2>&1
#
...
def get_option_chains():
    ...
    symbols =['AAPL', 'AMZN', 'GOOGL', 'META', 'MSFT', 'NVDA', 'TSLA', 'AVGO', 'ORCL', 'PLTR', 'TSM', 'MU', 'ANET']
    ...
    for symbol in symbols:
        ...
        # z_score=2 for 95.45% probability range (two standard deviation)
        # Must be a valid expiry date
        lower_95, upper_95 = analyze_price_range(current_price, annualized_volatility, days_to_expiry, z_score=2)
        ...
        option_chains_df = option_chains_df[(option_chains_df['strike'] >= option_chains_df['lower_95']) & (option_chains_df['strike'] <= option_chains_df['upper_95'])]
...
# Filter for only rows where between lower_95 and upper_95 (2 standard deviations)
#print('strike:', option_chains_df['strike'], ' lower_95:', lower_95, ' upper_95:', upper_95)
#option_chains_df = option_chains_df[(option_chains_df['strike'] >= lower_95) & (option_chains_df['strike'] <= upper_95)]
