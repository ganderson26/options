...
def hello_world():
    ...
    #return "<p>" + stock + " " + expiry + " " + strike + " PUT " + " Bid " + option_bid + " Volume " + option_volume + " Delta " + option_delta + " ROR " + option_ror + " IV " + option_iv + "</p>"
    return "<p>" + str(stock) + "</p>" + "<p>" + str(expiry) + "</p>" + "<p>" + str(strike) + "</p>" + "<p>PUT</p>" + "<p>" + "Delta: " + option_delta + "</p>" + "<p>" + "ROR: " + option_ror + "</p>" + "<p>" + "Volume: " + option_volume + "</p>" + "<p>" + "IV: " + option_iv + "</p>" + "<p>" + "Bid: " + option_bid + "</p>"
    

    #return "<p>HELLO</p>" + option_delta
